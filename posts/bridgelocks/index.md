---
layout: default
title: "Bridge Logistics: The Statistical Supremacy of the Ballard Commute"
permalink: /post/bridgelocks/
published: false
---

# Bridge Logistics: The Statistical Supremacy of the Ballard Commute

> May 18, 2026

<div style="background-color: #f4f4f0; border-left: 4px solid #007bff; padding: 15px; margin-bottom: 25px;">
  <strong>SUMMARY</strong><br>
  Which bridge should I take — and when should I leave? We performed a data-driven analysis of Fremont vs. Ballard drawbridge closure patterns, built from 130 active weekdays of historical closure logs. Our verdict? The data proves you should always take Ballard.
</div>

<a href="/posts/bridgelocks/PROBABILITY_README.md" style="display: block; text-align: center; background-color: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 20px auto; width: fit-content;" target="_blank">Read the Full Probability Methodology</a>

Every day, thousands of Seattle commuters face a grueling choice: Do I take the Fremont Bridge, or the Ballard Bridge? To the untrained eye, both seem like equally valid paths across the Lake Washington Ship Canal. Both have views of the water. Both occasionally trap you in a line of idling cars while a yacht named *Sea Señor* slowly parades past. But we are not the untrained eye. We are the Ministry of Silly Plots.

And we're here to tell you that from a statistical standpoint, choosing the Fremont Bridge is basically commuting malpractice.

In this analysis, we tracked 130 active weekdays of historical closure logs. We capped extreme outliers at 10 minutes to prevent a handful of mechanical failures from breaking the math. By computing the exact integral of wait times across 5-minute intervals, we’ve pinpointed exactly when you should leave the house—and more importantly, why the Ballard Bridge reigns supreme.
...
![24-Hour Clock Plots](/posts/bridgelocks/assets/analog_clocks.png)
...
![Morning Closure Probability](/posts/bridgelocks/assets/fremont_vs_ballard_morning_clean.png)

### Expected Wait Time

![Morning Expected Wait Time](/posts/bridgelocks/assets/expected_wait_morning.png)
...
![Afternoon Closure Probability](/posts/bridgelocks/assets/fremont_vs_ballard_afternoon_clean.png)

### Expected Wait Time

![Afternoon Expected Wait Time](/posts/bridgelocks/assets/expected_wait_afternoon.png)
...
![Lead-Lag Distribution](/posts/bridgelocks/assets/bridge_correlation_lags.png)
...
<a href="/posts/bridgelocks/PROBABILITY_README.md" style="display: block; text-align: center; background-color: #007bff; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 20px auto; width: fit-content;">Read the Full Technical Methodology</a>
